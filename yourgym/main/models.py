...
class Subscription(models.Model):
    ...
    price_month = models.DecimalField(decimal_places=2, max_digits=6,
...
class CartItem(models.Model):
    item = models.ForeignKey(Stock, on_delete=models.CASCADE,
                             related_name='cart')
    cartowner = models.ForeignKey(Cart, on_delete=models.CASCADE,
                                  related_name='cart')
...
class Participant(models.Model):
    ...
    session = models.ManyToManyField(Event, blank=True,
